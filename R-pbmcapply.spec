...
Version  : 1.3.0
Release  : 5
URL      : https://cran.r-project.org/src/contrib/pbmcapply_1.3.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pbmcapply_1.3.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1541426029
