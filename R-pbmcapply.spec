...
Version  : 1.2.5
Release  : 1
URL      : https://cran.r-project.org/src/contrib/pbmcapply_1.2.5.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pbmcapply_1.2.5.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1530315793
