...
Version  : 1.5.1
Release  : 46
URL      : https://cran.r-project.org/src/contrib/pbmcapply_1.5.1.tar.gz
Source0  : https://cran.r-project.org/src/contrib/pbmcapply_1.5.1.tar.gz
...
%setup -q -n pbmcapply
pushd ..
cp -a pbmcapply buildavx2
popd
pushd ..
cp -a pbmcapply buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737152429
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/pbmcapply/libs/pbmcapply.so
/V4/usr/lib64/R/library/pbmcapply/libs/pbmcapply.so
